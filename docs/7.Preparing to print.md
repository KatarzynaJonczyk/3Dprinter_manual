...
2. Press down firmly on the printer lid and pull the lid upwards by the handle.
...
4. Upload a .scode file to the printer. You can send it from the [Sinterit Studio Software](https://sinterit.com/software/) via Wi-Fi network or by inserting flash drive into the USB port. 
